    ...
    <>
      ...
      <Layout>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
          {/* Instructor Header - Simplified Layout */}
          <div className="flex flex-col lg:flex-row items-start gap-8 mb-8">
            ...
            <div className="flex-1 text-center lg:text-left">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between lg:justify-start gap-4 mb-4">
                  ...
                  <div className="flex flex-wrap gap-2 justify-center sm:justify-end lg:justify-start">
                    {teacherDetails.socialLinks.youtube && (
                      <a
                        ...
                        className="bg-red-500 text-white px-3 py-1 rounded-lg hover:bg-red-600 transition-colors flex items-center gap-1 text-xs"
                      >
                    ...
                    {teacherDetails.socialLinks.website && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="bg-green-500 text-white px-3 py-1 rounded-lg hover:bg-green-600 transition-colors flex items-center gap-1 text-xs"
                      >
                        <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 24 24">
